...
def plot_f1_scores_histogram(f1_scores, title='Histogram of Subject FPR',
    ...
    custom_x_ticks = np.arange(0, 1.1, 0.1) # custom_x_ticks = np.arange(0, 1.1, 0.1)
...
if __name__ == "__main__":
    ...
    # csv_file_path = "D:/seizure/results/0529_catch22_seed41_TUSZ/results_w_fp.csv"
    ...
    csv_file_path = 'D:/seizure/results/0529_catch22_seed41_TUSZ/avg_score_per_subject.csv'
